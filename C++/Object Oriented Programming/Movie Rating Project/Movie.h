...
class Movie {
 ...
 public:
  ...
  void set_name(std::string name_val) { this->name = name_val; }
  std::string get_name() const { return name; }

  void set_rating(std::string rating_val) { this->rating = rating_val; }
  std::string get_rating() const { return rating; }

  void set_watched(int watched_val) { this->watched = watched_val; }
